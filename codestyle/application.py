...
from codestyle.tool_wrappers import (Autoflake, Autopep8, ConsoleTool,
                                     Flake8, HTMLCS, Result,
...
ENABLED_TOOLS = (Flake8, Autopep8, Autoflake, HTMLCS,
                 Stylelint, MyPy, Black, ShellCheck, Hadolint, AnsibleLint)
